...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	row.frame = CGRectMake(row.frame.origin.x,
							...
							x,
							height);
   // row.backgroundColor = [UIColor colorWithRed:0.121f green:0.129f blue:0.145f alpha:1.0f];
    row.backgroundColor = [UIColor clearColor];
   // row.backgroundColor = [UIColor colorWithRed:31.0f/255.0f green:33.0f/255.0f blue:36.0f/255.0f alpha:0.5f];
//     row.backgroundColor = [UIColor colorWithRed:24.0f/255.0f green:25.0f/255.0f blue:28.0f/255.0f alpha:0.0f];
...
- (IBAction) cellPressed:(id) sender
{
    ...
    [uiGridViewDelegate gridView:self didSelectRowAt:cell.rowIndex AndColumnAt:cell.colIndex currentGridCell:cell];
    
    //[uiGridViewDelegate gridViewSendCell:self Cell:cell];
    
   // [uiGridViewDelegate  gridViewSendTempCell:self didSelectRowAt:cell.rowIndex AndColumnAt:cell.colIndex TempCell:cell];
