...
- (UILabel *)fixedLabel
{
    if (_fixedLabel == nil) {
        ...
        //_fixedLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 20, 40)];
...
- (UILabel *)scrollableLabel
{
    if (_scrollableLabel == nil) {
       ...
       // _scrollableLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 20, 40)];
        _scrollableLabel.backgroundColor = [UIColor whiteColor];
